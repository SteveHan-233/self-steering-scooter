...
<mujoco>
    ...
    <worldbody>
        ...
        <body> 
            <geom type="cylinder" pos="-2 0 -.95" size="1 3" euler="90 10 30" />
            <geom type="cylinder" pos="-5 0 -.98" size="1 5" euler="90 -20 -30" />
            <geom type="cylinder" pos="-10 0 -4.8" size="5 5" euler="90 20 30" />
        </body>
    </worldbody>
    <actuator>
