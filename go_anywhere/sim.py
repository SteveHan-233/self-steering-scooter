...
<mujoco>
    ...
    <worldbody>
        <body name="camera" mocap="true" pos="0 0 0" euler="0 0 0">
            <camera name="top_view" pos="0 0 100" />
        </body>
        <geom type="plane" material="grid" pos="-80 0 0" size="150 150 .1"/>
        ...
        <body>
            <geom type="cylinder" pos="0 0 3" size="1.3 3" rgba="1 0 0 1"/>
            <joint type="free" name="goal"/>
        </body>
    </worldbody>
    <actuator>
...
class Sim(gym.Env):
    ...
    def reset(self):
        ...
        #self.goal_pos = [goal_r * math.cos(goal_angle), goal_r * math.sin(goal_angle)]
        self.goal_pos = [-50, 0]
        print(self.goal_pos)
        #self.physics.named.data.qpos['goal'][:2] = self.goal_pos
